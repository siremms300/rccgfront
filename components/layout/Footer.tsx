        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/teachings" className="text-gray-400 hover:text-white transition-colors">Teachings</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-gray-400">Sunday Service</p>
                  <p className="text-white font-medium">8:00 AM & 10:00 AM</p>
                </div>
              </li>
              <li className="flex items-center space-x-3">
                <Clock className="w-5 h-5 text-gray-400" />
                <div>
                  <p className="text-gray-400">Bible Study</p>
                  <p className="text-white font-medium">Wednesdays 6:00 PM</p>
                </div>
              </li>
              <li className="flex items-center space-x-3">
                <Clock className="w-5 h-5 text-gray-400" />
                <div>
                  <p className="text-gray-400">Prayer Meeting</p>
                  <p className="text-white font-medium">Fridays 6:00 PM</p>
                </div>
              </li>
            </ul>
          </div>
